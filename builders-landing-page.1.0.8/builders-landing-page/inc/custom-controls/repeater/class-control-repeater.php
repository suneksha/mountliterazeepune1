<?php
/**
 * Builders Landing Page Customizer Repeater Control.
 * 
...
if( ! class_exists( 'Builders_Landing_Page_Control_Repeater' ) ) {
    ...
    class Builders_Landing_Page_Control_Repeater extends WP_Customize_Control {
    	 ...
    	 * @var string
    	 */
    	public $type = 'builders-landing-page-repeater';
    	...
    	public function enqueue() {    
            ...
            wp_enqueue_script( 'builders-landing-page-repeater', get_stylesheet_directory_uri() . '/inc/custom-controls/repeater/repeater.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-sortable' ), false, true );
    		wp_enqueue_style( 'builders-landing-page-repeater', get_stylesheet_directory_uri() . '/inc/custom-controls/repeater/repeater.css', null );
    	}
    	...
    	protected function render_content() {
    		...
    		<?php if ( isset( $this->choices['limit'] ) ) : ?>
    			<p class="limit"><?php printf( esc_html__( 'Limit: %s rows', 'builders-landing-page' ), esc_html( $this->choices['limit'] ) ); ?></p>
    		<?php endif; ?>
    		...
    		<script type="text/html" class="customize-control-repeater-content">
    			...
    			<li class="repeater-row minimized" data-row="{{{ index }}}">
    				...
    				<div class="repeater-row-content">
    					<# _.each( data, function( field, i ) { #>
    						...
    						<div class="repeater-field repeater-field-{{{ field.type }}}">
    							...
    							<# } else if ( field.type === 'image' || field.type === 'cropped_image' ) { #>
    								...
    								<figure class="builders-landing-page-image-attachment" data-placeholder="<?php esc_attr_e( 'No Image Selected', 'builders-landing-page' ); ?>" >
    									<# if ( field.default ) { #>
    										<# var defaultImageURL = ( field.default.url ) ? field.default.url : field.default; #>
    										<img src="{{{ defaultImageURL }}}">
    									<# } else { #>
    										<?php esc_attr_e( 'No Image Selected', 'builders-landing-page' ); ?>
    									<# } #>
    								</figure>
    
    								<div class="actions">
    									<button type="button" class="button remove-button<# if ( ! field.default ) { #> hidden<# } #>"><?php esc_attr_e( 'Remove', 'builders-landing-page' ); ?></button>
    									<button type="button" class="button upload-button" data-label=" <?php esc_attr_e( 'Add Image', 'builders-landing-page' ); ?>" data-alt-label="<?php esc_attr_e( 'Change Image', 'builders-landing-page' ); ?>" >
    										<# if ( field.default ) { #>
    											<?php esc_attr_e( 'Change Image', 'builders-landing-page' ); ?>
    										<# } else { #>
    											<?php esc_attr_e( 'Add Image', 'builders-landing-page' ); ?>
    										<# } #>
    									</button>
    									<# if ( field.default.id ) { #>
    							...
    							<# } else if ( field.type === 'upload' ) { #>
    								...
    								<figure class="builders-landing-page-file-attachment" data-placeholder="<?php esc_attr_e( 'No File Selected', 'builders-landing-page' ); ?>" >
    									<# if ( field.default ) { #>
    									...
    									<# } else { #>
    										<?php esc_attr_e( 'No File Selected', 'builders-landing-page' ); ?>
    									<# } #>
    								</figure>
    
    								<div class="actions">
    									<button type="button" class="button remove-button<# if ( ! field.default ) { #> hidden<# } #>"></button>
    									<button type="button" class="button upload-button" data-label="<?php esc_attr_e( 'Add File', 'builders-landing-page' ); ?>" data-alt-label="<?php esc_attr_e( 'Change File', 'builders-landing-page' ); ?>" >
    										<# if ( field.default ) { #>
    											<?php esc_attr_e( 'Change File', 'builders-landing-page' ); ?>
    										<# } else { #>
    											<?php esc_attr_e( 'Add File', 'builders-landing-page' ); ?>
    										<# } #>
    									</button>
    									<# if ( field.default.id ) { #>
    										<input type="hidden" class="hidden-field" value="{{{ field.default.id }}}" data-field="{{{ field.id }}}" >
    					...
    					<# }); #>
    					<button type="button" class="button-link repeater-row-remove"><?php esc_attr_e( 'Remove', 'builders-landing-page' ); ?></button>
    				</div>
    			</li>
    		</script>
    		<?php
